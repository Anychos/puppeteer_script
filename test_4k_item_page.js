...
(async () => {  // Функция инициализации браузера
    ...
    await page.goto('https://a101-shop-front-specstorea-359.ktsdev.ru/?platform=stand', { waitUntil: 'networkidle2' });

    await new Promise(resolve => setTimeout(resolve, 5000));

    await page.screenshot({ path: 'delayed-screenshot_catalog.png', fullPage: true });
    ...
    await page.screenshot({ path: 'delayed-screenshot_sort_menu.png', fullPage: true });
    ...
    await page.screenshot({ path: 'delayed-screenshot_filter_menu.png', fullPage: true });
    ...
    await page.screenshot({ path: 'delayed-screenshot_product_card.png', fullPage: true });
    ...
    await page.screenshot({ path: 'delayed-screenshot_make_order.png', fullPage: true });

    await new Promise(resolve => setTimeout(resolve, 5000));

    // Клик по кнопке выбора пвз
    await page.click('#root > div.eRdLFkQ6t3M\\= > div > div > div.X3RIOxB4Hfw\\=.hnvkvWHmDgE\\=.JwuYSr-6W7I\\= > div > div:nth-child(4) > div');

    await new Promise(resolve => setTimeout(resolve, 5000));

    await page.screenshot({ path: 'delayed-screenshot_map.png', fullPage: true });

    await new Promise(resolve => setTimeout(resolve, 5000));

    // Клик по пвз в списке
    ...
    await page.screenshot({ path: 'delayed-screenshot_map_pvz.png', fullPage: true });
