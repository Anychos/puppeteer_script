...
(async () => {  // Функция инициализации браузера
    ...
    await page.goto('https://a101-shop-front-specstorea-355.ktsdev.ru/?platform=stand', { waitUntil: 'networkidle2' });
    ...
    await page.screenshot({ path: 'delayed-screenshot_add_to_cart_product.png', fullPage: true });
    ...
    await page.screenshot({ path: 'delayed-screenshot_full_product_cart.png', fullPage: true });
    await new Promise(resolve => setTimeout(resolve, 5000));
